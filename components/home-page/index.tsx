        ...
        <div className="space-y-4 md:space-y-6 md:pr-8 xl:col-span-2">
          ...
          <div className="text-base leading-7 text-gray-600 dark:text-gray-400 md:text-lg md:leading-8">
            ...
            <div className="mb-6 mt-4 md:mb-8">
              Here, I share my thoughts, tips and experiences on software development,
              methodologies, design patterns, and best practices. I aim to help software engineers
              of all levels improve their skills and knowledge.
            </div>
          </div>
        </div>
